...
const Icon = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex items-center justify-center w-14 h-14 md:w-[72px] md:h-[72px] p-3 rounded-2xl shadow-xl bg-white/[0.04] backdrop-blur-md border border-white/[0.06]"
        animate={{
          y: [0, -8, 0, 8, 0],
          x: [0, 6, 0, -6, 0],
          rotate: [0, 5, 0, -5, 0],
